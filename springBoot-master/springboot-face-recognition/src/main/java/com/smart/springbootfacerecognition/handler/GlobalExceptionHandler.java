...
import com.smart.springbootfacerecognition.exception.code.Code;
...
public class GlobalExceptionHandler {
    ...
    public FebsResponse handleException(Exception e) {
        ...
        if(Code.NeedLogin.getDesc().equals(message)){
            return new FebsResponse().message(message).code(Code.NeedLogin.getCode().toString()).status(ResponseStat.ERROR.getText());
        }
 ...
 /*   @ExceptionHandler(value = UnauthorizedException.class)
     ...
     * @return FebsResponse
     */
    @ExceptionHandler({BindException.class, MethodArgumentNotValidException.class, HttpMessageNotReadableException.class, ConstraintViolationException.class, MissingServletRequestParameterException.class})
    ...
    public FebsResponse validExceptionHandler(Exception e) {
        ...
        if(e instanceof BindException || e instanceof MethodArgumentNotValidException){
            ...
            message = new StringBuilder(e.getMessage().substring(0, e.getMessage().indexOf(COLON)));
