...
public class FileUtil {
     ...
     * @throws IOException
     */
    public static void saveBit(InputStream inStream, String path) throws IOException {
...
//        long fileSize = imgFile.length();
    ...
    public static byte[] filebyteToGBK(byte[] inputFilebyte) throws UnsupportedEncodingException {
        String s = new String(inputFilebyte, "utf-8");
