package com.smart._springbootuniappmui.muiwrapper.controller;
 ...
 */
    ...
    public ModelAndView main() {
        ...
        try {
            ...
            //buttomList = "[{\"text\":\"mui原生\",\"icon\":\"mui-icon-phone\",\"url\":\"/muiwrapper/home\"},{\"text\":\"自定义封装\",\"icon\":\"mui-icon-email\",\"url\":\"/muiwrapper/dialog\"},{\"text\":\"头尾操作\",\"icon\":\"mui-icon-chatbubble\",\"url\":\"/muiwrapper/test3\"},{\"text\":\"页面切换\",\"icon\":\"mui-icon-weixin\",\"url\":\"/muiwrapper/test4\"}]";
            buttomList = "[{\"text\":\"mui原生\",\"icon\":\"mui-icon-phone\",\"url\":\"/muiwrapper/home\"}]";
    ...
    public ModelAndView dialog(){
        return new ModelAndView("muiwrapper/home");
    }
